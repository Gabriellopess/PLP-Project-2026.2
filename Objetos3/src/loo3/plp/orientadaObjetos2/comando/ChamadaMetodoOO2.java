...
import loo3.plp.orientadaObjetos1.comando.ChamadaMetodo;
...
import loo3.plp.orientadaObjetos1.excecao.execucao.EntradaInvalidaException;
...
import loo3.plp.orientadaObjetos1.expressao.valor.ValorRef;
...
import loo3.plp.orientadaObjetos1.memoria.Objeto;
import loo3.plp.orientadaObjetos1.memoria.colecao.ListaValor;
import loo3.plp.orientadaObjetos1.util.Tipo;
import loo3.plp.orientadaObjetos3.excecao.execucao.ChamadaMetodoInvalidaException;
import loo3.plp.orientadaObjetos2.memoria.AmbienteExecucaoOO2;
import loo3.plp.orientadaObjetos2.memoria.ContextoExecucaoOO2;
...
import loo3.plp.orientadaObjetos2.util.HierarquiaUtils;
import loo3.plp.orientadaObjetos3.util.ProtocoloUtils;
import loo3.plp.orientadaObjetos3.util.TipoDinamico;
...
public class ChamadaMetodoOO2 extends ChamadaMetodo {
	...
	public AmbienteExecucaoOO1 executar(AmbienteExecucaoOO1 ambiente) throws VariavelJaDeclaradaException, VariavelNaoDeclaradaException,
		...
		DefClasse defClasse = ambiente.getDefClasse((loo3.plp.expressions2.expression.Id) idClasse);
		...
		new ChamadaProcedimentoOO3(metodo, parametrosReais, valoresDosParametros).executar(aux);
		return ambiente;
	}
	...
	public boolean checaTipo(AmbienteCompilacaoOO1 ambiente) throws VariavelNaoDeclaradaException,
		...
		if (tipoReceptor instanceof TipoDinamico) {
			...
			return ChamadaProcedimentoOO3.checaTipoArgumentos(parametrosReais, ambiente);
		}
		...
		if (protocolo != null) {
			...
			try {
				...
				ambiente.incrementa();
				resposta = new ChamadaProcedimentoOO3(assinatura, parametrosReais).checaTipo(ambiente);
				ambiente.restaura();
		...
		try {
			...
			resposta = new ChamadaProcedimentoOO3(metodo, parametrosReais).checaTipo(ambiente);
			ambiente.restaura();
		} catch (ProcedimentoNaoDeclaradoException e) {
			resposta = false;
		}
