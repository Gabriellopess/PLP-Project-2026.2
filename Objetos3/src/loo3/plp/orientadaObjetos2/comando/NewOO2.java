...
import loo3.plp.orientadaObjetos1.comando.ChamadaProcedimento;
import loo3.plp.orientadaObjetos1.comando.New;
import loo3.plp.orientadaObjetos1.comando.Procedimento;
import loo3.plp.orientadaObjetos1.declaracao.variavel.DecVariavel;
...
public class NewOO2 extends New {
	...
	private void extendsClasse(AmbienteExecucaoOO2 ambiente, DefClasseOO2 classe, Objeto objeto) throws ClasseNaoDeclaradaException, 
		...
		HashMap<loo3.plp.expressions2.expression.Id, Valor> estadoObj = aux.getPilha().pop();
		
		for (loo3.plp.expressions2.expression.Id id : estadoObj.keySet()) {
