package loo3.plp.orientadaObjetos1.comando;
...
public class ChamadaMetodo implements Comando {
    ...
    public AmbienteExecucaoOO1 executar(AmbienteExecucaoOO1 ambiente)
        ...
        DefClasse defClasse = ambiente.getDefClasse((loo3.plp.expressions2.expression.Id)idClasse); // recupera a defini��o da classe
