package loo3.plp.expressions1.util;
...
public enum TipoPrimitivo implements Tipo {
	...
	/* (non-Javadoc)
	 * @see loo3.plp.expressions1.util.Tipo#getNome()
	 */
	...
	/* (non-Javadoc)
	 * @see loo3.plp.expressions1.util.Tipo#eInteiro()
	 */
	...
	/* (non-Javadoc)
	 * @see loo3.plp.expressions1.util.Tipo#eBooleano()
	 */
	...
	/* (non-Javadoc)
	 * @see loo3.plp.expressions1.util.Tipo#eString()
	 */
	...
	/* (non-Javadoc)
	 * @see loo3.plp.expressions1.util.Tipo#eIgual(loo3.plp.expressions1.util.Tipo)
	 */
	...
	/* (non-Javadoc)
	 * @see loo3.plp.expressions1.util.Tipo#eValido()
	 */
	...
	/* (non-Javadoc)
	 * @see loo3.plp.expressions1.util.Tipo#intersecao(loo3.plp.expressions1.util.Tipo)
	 */
